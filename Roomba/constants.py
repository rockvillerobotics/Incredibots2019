...
# Servo Limits
MAX_ARM_SERVO_LIMIT = 2047
MIN_ARM_SERVO_LIMIT = 1282
    
MAX_ARM_SERVO_POS = 2004
MIN_ARM_SERVO_POS = 946

    
MAX_CLAW_SERVO_POS = 785
MIN_CLAW_SERVO_POS = 190

# Servo Base Positions
ARM_UP_POS = 1770
ARM_DOWN_POS = 1010
ARM_JUST_BARELY_ON_T_POS = NO_CURRENT_VALUE
ARM_DELIVERY_POS = 1254
ARM_JUST_BELOW_T_POS = NO_CURRENT_VALUE
ARM_HALF_UP_POS = 575
